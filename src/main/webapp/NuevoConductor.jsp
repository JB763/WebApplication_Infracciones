      ...
      <div class="col-12 col-md-9 col-lg-7 col-xl-6">
        <div class="card" style="border-radius: 15px;">
          <div class="card-body p-5">
            <h2 class="text-uppercase text-center mb-5">Nuevo Registro - Conductor</h2>

            <form name="frmConductor" action="srvInsertarConductor" method="post">
              ...
              <div data-mdb-input-init class="form-outline mb-4">
                <input type="text" id="edad" class="form-control form-control-lg" name="txtEdad" required />
