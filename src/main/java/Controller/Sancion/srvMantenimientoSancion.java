 ...
 * @author JULIAN BRITO
 */
@WebServlet(name = "srvMantenimientoSancion", urlPatterns = {"/srvMantenimientoSancion"})
public class srvMantenimientoSancion extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        rd = request.getRequestDispatcher("MantenimientoSancion.jsp");
