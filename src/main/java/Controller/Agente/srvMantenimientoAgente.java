 ...
 * @author JULIAN BRITO
 */
@WebServlet(name = "srvMantenimientoAgente", urlPatterns = {"/srvMantenimientoAgente"})
public class srvMantenimientoAgente extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String idAgente;
        idAgente = (request.getParameter("txtidAgente").toString());
        request.setAttribute("idAgente", idAgente);
