 ...
 * @author JULIAN BRITO
 */
@WebServlet(name = "srvActualizarUsuario", urlPatterns = {"/srvActualizarUsuario"})
public class srvActualizarUsuario extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int respuesta = srvUsuario.getSrvUsuarioPort().actualizarUsuario(idUsuario, usuario, password, correo, idAgente);
        ...
        RequestDispatcher rd = request.getRequestDispatcher("ActualizarUsuario.jsp?iD=" + idUsuario);
