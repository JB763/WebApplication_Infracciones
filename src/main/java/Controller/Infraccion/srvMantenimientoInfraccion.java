 ...
 * @author JULIAN BRITO
 */
@WebServlet(name = "srvMantenimientoInfraccion", urlPatterns = {"/srvMantenimientoInfraccion"})
public class srvMantenimientoInfraccion extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String idInfraccion;
        idInfraccion = (request.getParameter("txtidInfraccion").toString());
        request.setAttribute("idInfraccion", idInfraccion);
