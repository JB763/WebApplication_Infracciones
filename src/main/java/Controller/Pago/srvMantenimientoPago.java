 ...
 * @author JULIAN BRITO
 */
@WebServlet(name = "srvMantenimientoPago", urlPatterns = {"/srvMantenimientoPago"})
public class srvMantenimientoPago extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("MantenimientoPago.jsp").forward(request, response);
    }
